            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        ...
                        <img class="img-fluid rounded w-50 float-left mr-4 mb-3" src="<?php get_url() ?>img/blog-1.jpg" alt="Image">
                        ...
                        <img class="img-fluid rounded w-50 float-right ml-4 mb-3" src="<?php get_url() ?>img/blog-2.jpg" alt="Image">
                        <p>Diam dolor est labore duo invidunt ipsum clita et, sed et lorem voluptua tempor invidunt at
                            est
                            sanctus sanctus. Clita dolores sit kasd diam takimata justo diam lorem sed. Magna amet sed
                            rebum
                    ...
                    <div class="mb-5">
                        ...
                        <div class="media mb-4">
                            <img src="<?php get_url() ?>img/user.jpg" alt="Image" class="img-fluid rounded-circle mr-3 mt-1" style="width: 45px;">
                        ...
                        <div class="media mb-4">
                            ...
                            <div class="media-body">
                                ...
                                <div class="media mt-4">
                                    <img src="<?php get_url() ?>img/user.jpg" alt="Image" class="img-fluid rounded-circle mr-3 mt-1"
                                        style="width: 45px;">
                                    <div class="media-body">
                                        <h6>John Doe <small><i>01 Jan 2045 at 12:00pm</i></small></h6>
                                        <p>Diam amet duo labore stet elitr ea clita ipsum, tempor labore accusam ipsum et no at. Kasd diam tempor rebum magna dolores sed sed eirmod ipsum clita, at tempor amet ipsum diam tempor sit.</p>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="d-flex flex-column text-center bg-secondary rounded mb-5 py-5 px-4">
                        <img src="<?php get_url() ?>img/user.jpg" class="img-fluid rounded-circle mx-auto mb-3" style="width: 100px;">
                    ...
                    <div class="mb-5">
                        <img src="<?php get_url() ?>img/blog-1.jpg" alt="" class="img-fluid rounded">
                    </div>
                    <div class="mb-5">
                        <h3 class="mb-4 section-title">Recent Post</h3>
                        <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                            <img class="img-fluid rounded" src="<?php get_url() ?>img/blog-1.jpg" style="width: 80px; height: 80px; object-fit: cover;" alt="">
                        ...
                        <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                            <img class="img-fluid rounded" src="<?php get_url() ?>img/blog-2.jpg" style="width: 80px; height: 80px; object-fit: cover;" alt="">
                            <div class="d-flex flex-column pl-3">
                                <a class="text-dark mb-2" href="">Elitr diam amet sit elitr magna ipsum ipsum dolor</a>
                                <div class="d-flex">
                                    <small><a class="text-secondary text-uppercase font-weight-medium" href="">Admin</a></small>
                        ...
                        <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                            <img class="img-fluid rounded" src="<?php get_url() ?>img/blog-3.jpg" style="width: 80px; height: 80px; object-fit: cover;" alt="">
                            <div class="d-flex flex-column pl-3">
                                <a class="text-dark mb-2" href="">Elitr diam amet sit elitr magna ipsum ipsum dolor</a>
                                <div class="d-flex">
                                    <small><a class="text-secondary text-uppercase font-weight-medium" href="">Admin</a></small>
                    ...
                    <div class="mb-5">
                        <img src="<?php get_url() ?>img/blog-2.jpg" alt="" class="img-fluid rounded">
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        <img src="<?php get_url() ?>img/blog-3.jpg" alt="" class="img-fluid rounded">
                    </div>
                    <div>
